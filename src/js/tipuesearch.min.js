         ...
         return this.each(function() {
              ...
              function getTipueSearch(start, replace)
              {
                   ...
                   if (d.length >= set.minimumLength)
                   {
                        ...
                        {
                             out += '<div id="tipue_search_error"><div class="nhsuk-grid-column-two-thirds"><h2>No results found for ' + d + '</h2><p>You could try:</p>        <ul class="nhsuk-list nhsuk-list--bullet"><li>checking your spelling</li><li>searching again using other words</li><li>looking for the topic in our <a href="https://www.nhs.uk/conditions/">Health A to Z</a></li></ul><p>If you need medical help now and you\'re not sure what to do, go to <a href="https://111.nhs.uk/">111.nhs.uk</a> or call 111</p></div></div>'; 
                        }
                   }
                   else
                   {
