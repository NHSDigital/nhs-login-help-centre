      ...
      function getTipueSearch(start, replace) {
        ...
        if (d.length >= set.minimumLength) {
          ...
          if (c != 0) {
            ...
            if (c == 1) {
              out +=
                '<div id="tipue_search_results_count">Found <strong>1</strong> matching result';
            } else {
              var c_c = c.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
              out +=
                '<div id="tipue_search_results_count">Found <strong>' +
                c_c +
                ' ' +
            ...
            for (var i = 0; i < found.length; i++) {
              if (l_o >= start && l_o < set.show + start) {
                ...
                out +=
                  '<h2 class="nhsuk-u-margin-bottom-1" style="font-weight: 400;font-size: 19px"><a href="' +
                  found[i].url +
                  '"' +
                  tipue_search_w +
                  '>' +
                ...
                if (set.debug) {
                  out +=
                    '<div class="tipue_search_content_debug">Score: ' + found[i].score + '</div>';
                }
            ...
            if (c > set.show) {
              ...
              out +=
                '<nav class="nhsuk-pagination" role="navigation" aria-label="Pagination"><ul class="nhsuk-list nhsuk-pagination__list">';
              ...
              if (page + 1 != pages) {
                ...
                out += `<li class="nhsuk-pagination-item--next">
                                                  <a class="nhsuk-pagination__link nhsuk-pagination__link--next"
                                                       ...
                                                       <span class="nhsuk-u-visually-hidden">:</span>
                                                       <span class="nhsuk-pagination__page">Page ${page +
                                                         2} of ${pages}</span>
            ...
            out +=
              '<div id="tipue_search_error"><div class="nhsuk-grid-column-two-thirds"><h2>No results found for ' +
              d +
              '</h2><p>Improve your search results by:</p>        <ul class="nhsuk-list nhsuk-list--bullet"><li>double-checking your spelling</li><li>using fewer keywords</li><li>searching a reference number</li></ul></div></div>';
          }
        } else {
          if (show_stop) {
            out +=
